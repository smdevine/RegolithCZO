...
result_order <- espa_order(input_ids = data_source$product_id, product = c("sr_ndvi", "sr_evi"), projection = "lonlat", order_note = paste0("Soaproot cover", year)) #including source data "sr" and "toa" requires too much memory
