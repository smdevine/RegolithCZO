...
summary(lm(Depth_log ~ curv_mean_N, data = soaproot_pts_analysis))
summary(lm(Depth_log ~ elev_above_str_N, data = soaproot_pts_analysis))
plot(lm(Depth_log ~ elev_above_str_N, data = soaproot_pts_analysis))
summary(lm(Depth_log ~ stream_dist_N, data = soaproot_pts_analysis))
summary(lm(Depth_log ~ stream_dist_N + curv_mean_N, data = soaproot_pts_analysis))
summary(lm(Depth_log ~ stream_dist_N + curv_prof_N, data = soaproot_pts_analysis)) #best r2=0.18
summary(lm(Depth_log ~ stream_dist_N + curv_plan_N, data = soaproot_pts_analysis)) #worst
summary(lm(Depth_log ~ stream_dist_N + TPI_N, data = soaproot_pts_analysis))
summary(lm(Depth_log ~ stream_dist_N + OCdist_R, data = soaproot_pts_analysis))
...
boxplot(curv_mean_N ~ depth_class, data = soaproot_pts_analysis)
t.test(curv_mean_N ~ depth_class, data = soaproot_pts_analysis)
result.curv_mean.aov <- aov(curv_mean_N ~ depth_class, data = soaproot_pts_analysis)
summary(result.curv_mean.aov)

boxplot(stream_dist_N ~ depth_class, data = soaproot_pts_analysis)
t.test(stream_dist_N ~ depth_class, data = soaproot_pts_analysis)
result.stream_dist.aov <- aov(stream_dist_N ~ depth_class, data = soaproot_pts_analysis)
summary(result.stream_dist.aov)
TukeyHSD(result.stream_dist.aov)

boxplot(elev_above_str_N ~ depth_class, data = soaproot_pts_analysis)
t.test(elev_above_str_N ~ depth_class, data = soaproot_pts_analysis)
result.stream_dist.aov <- aov(elev_above_str_N ~ depth_class, data = soaproot_pts_analysis)
summary(result.stream_dist.aov)
TukeyHSD(result.stream_dist.aov)
...
boxplot(elev_above_str_N ~ depth_class, data = soaproot_pts_analysis)
t.test(slope_N ~ depth_class, data = soaproot_pts_analysis)
result.slope.aov <- aov(slope_N ~ depth_class, data = soaproot_pts_analysis)
summary(result.slope.aov)
TukeyHSD(result.slope.aov)
