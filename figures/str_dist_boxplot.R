...
#elev plot
tiff(file = file.path(FiguresDir, 'elevation_vioplots.tif'), family = 'Times New Roman', pointsize = 11, width = 4.5, height = 3.5, units = 'in', res=res_plots, compression = 'lzw')
par(mar=c(4.5, 4.5, 0.5, 0.5))
vioplot(soaproot_pts_analysis$elev_N[soaproot_pts_analysis$depth_class==1], soaproot_pts_analysis$elev_N[soaproot_pts_analysis$depth_class==2], soaproot_pts_analysis$elev_N[soaproot_pts_analysis$depth_class==3], xlab=c('Regolith depth class (m)'), ylab='Elevation (m)', names=c('Shallow <3.3', 'Moderate 3.3-7.5', 'Deep >7.5'))
dev.off()

#slope
tiff(file = file.path(FiguresDir, 'slope_vioplots.tif'), family = 'Times New Roman', pointsize = 11, width = 4.5, height = 3.5, units = 'in', res=res_plots, compression = 'lzw')
par(mar=c(4.5, 4.5, 0.5, 0.5))
vioplot(soaproot_pts_analysis$slope_N[soaproot_pts_analysis$depth_class==1], soaproot_pts_analysis$slope_N[soaproot_pts_analysis$depth_class==2], soaproot_pts_analysis$slope_N[soaproot_pts_analysis$depth_class==3], xlab=c('Regolith depth class (m)'), ylab=expression('Slope ('*degree*')'), names=c('Shallow <3.3', 'Moderate 3.3-7.5', 'Deep >7.5'))
dev.off()

#Annual solar radiation
tiff(file = file.path(FiguresDir, 'solrad_vioplots.tif'), family = 'Times New Roman', pointsize = 11, width = 4.5, height = 3.5, units = 'in', res=res_plots, compression = 'lzw')
par(mar=c(4.5, 4.5, 0.5, 0.5))
vioplot(soaproot_pts_analysis$solrad_N[soaproot_pts_analysis$depth_class==1], soaproot_pts_analysis$solrad_N[soaproot_pts_analysis$depth_class==2], soaproot_pts_analysis$solrad_N[soaproot_pts_analysis$depth_class==3], xlab=c('Regolith depth class (m)'), ylab=expression('Clear sky insolation (kWh'~yr^-1~m^-2*')'), names=c('Shallow <3.3', 'Moderate 3.3-7.5', 'Deep >7.5'))
dev.off()

#mean curv
tiff(file = file.path(FiguresDir, 'mean_curv_vioplots.tif'), family = 'Times New Roman', pointsize = 11, width = 4.5, height = 3.5, units = 'in', res=res_plots, compression = 'lzw')
par(mar=c(4.5, 4.5, 0.5, 0.5))
vioplot(soaproot_pts_analysis$curv_mean_N[soaproot_pts_analysis$depth_class==1], soaproot_pts_analysis$curv_mean_N[soaproot_pts_analysis$depth_class==2], soaproot_pts_analysis$curv_mean_N[soaproot_pts_analysis$depth_class==3], xlab=c('Regolith depth class (m)'), ylab=expression('Mean curvature (100'~m^-1*')'), names=c('Shallow <3.3', 'Moderate 3.3-7.5', 'Deep >7.5'))
dev.off()
